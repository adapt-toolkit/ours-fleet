...
mcp_revision=e17a58ef8fdbdfd919d9936231a66d23a4792294
...
node "$source_dir/scripts/normalize-review-tarball.mjs" "$artifact_dir/ours.network-mcp-1.1.2-supervisor.0.tgz"
